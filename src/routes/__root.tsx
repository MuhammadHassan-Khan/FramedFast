  ...
  head: () => ({
    meta: [
      ...
      { title: "FramedFast — Luxury Fashion Campaign Images in 48 Hours" },
      {
        name: "description",
        content:
          "Replace your next Rs.100,000 photoshoot with one phone photo. Premium fashion campaign visuals for Pakistani clothing brands, delivered in 48 hours.",
      },
      { name: "author", content: "FramedFast" },
      { property: "og:title", content: "FramedFast — Luxury Fashion Campaign Images in 48 Hours" },
      {
      ...
      { name: "twitter:site", content: "@FramedFast" },
    ],
    links: [
